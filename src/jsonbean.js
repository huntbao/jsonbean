  ...
  function jsonBean() {
    ...
    function peg$parse(input, options) {
      ...
      var peg$FAILED = {},
        ...
        peg$c30 = "private",
        peg$c31 = peg$literalExpectation("private", false),
        peg$c32 = "protected",
        peg$c33 = peg$literalExpectation("protected", false),
        peg$c34 = "static",
        peg$c35 = peg$literalExpectation("static", false),
        peg$c36 = "final",
        peg$c37 = peg$literalExpectation("final", false),
        peg$c38 = "transient",
        peg$c39 = peg$literalExpectation("transient", false),
        peg$c40 = "volatile",
        peg$c41 = peg$literalExpectation("volatile", false),
        peg$c42 = function(s, f) {
          /*
        ...
        peg$c52 = function(c) { // 因为都是包在一个java class 中, 所以一定有LB
          return c.join('')
        },
        peg$c53 = function(c) {
          return c
        ...
        peg$c74 = function(e, s, ds) {
          return e + (s==null? "" : s) + ds.join('');
        },
        peg$c75 = ".",
        peg$c76 = peg$literalExpectation(".", false),
        peg$c77 = function(s, d) {
        ...
        peg$c84 = peg$otherExpectation("Zero or more whitespaces"),
        peg$c85 = peg$otherExpectation("One or more whitespaces"),
        peg$c86 = /^[\r\n]/,
                  ...
                  if (s6 !== peg$FAILED) {
                    ...
                    if (s7 !== peg$FAILED) {
                      ...
                      if (s8 !== peg$FAILED) {
                        s9 = peg$parse_();
                        if (s9 !== peg$FAILED) {
                          s10 = peg$parseTraditionalArray();
                          if (s10 === peg$FAILED) {
                            s10 = null;
                          }
                          if (s10 !== peg$FAILED) {
                            s11 = peg$parseDefaultValueAssign();
                            if (s11 === peg$FAILED) {
                              s11 = null;
                            }
                            if (s11 !== peg$FAILED) {
                              ...
                              if (s12 !== peg$FAILED) {
                                s13 = peg$parse_();
                                if (s13 !== peg$FAILED) {
                                  s14 = peg$parseCommentOrLB();
                                  if (s14 !== peg$FAILED) {
                                    peg$savedPos = s0;
                                    s1 = peg$c4(s2, s4, s6, s8, s10, s11, s14);
                                    s0 = s1;
                                  } else {
                                    peg$currPos = s0;
                                    s0 = peg$FAILED;
